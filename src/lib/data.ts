...
import { Shirt, ParkingCircle, Wifi, ShowerHead, Lock, Dumbbell, Zap, Users, Trophy, Award, CalendarDays, Utensils, Star, LocateFixed, Clock, DollarSign, Goal, Bike, Dices, Swords, Music, Tent, Drama, MapPin, Heart, Basketball, TennisBall, Waves, Lotus, Activity, Feather } from 'lucide-react';

export const mockSports: Sport[] = [
  { id: 'sport-1', name: 'Soccer', icon: Goal, imageUrl: 'https://placehold.co/100x100.png?text=Soccer', imageDataAiHint: 'soccer ball' },
  { id: 'sport-2', name: 'Basketball', icon: Basketball, imageUrl: 'https://placehold.co/100x100.png?text=Basketball', imageDataAiHint: 'basketball hoop' },
  { id: 'sport-3', name: 'Tennis', icon: TennisBall, imageUrl: 'https://placehold.co/100x100.png?text=Tennis', imageDataAiHint: 'tennis racket' },
  ...
  { id: 'sport-9', name: 'Yoga', icon: Lotus, imageUrl: 'https://placehold.co/100x100.png?text=Yoga', imageDataAiHint: 'yoga mat'},
