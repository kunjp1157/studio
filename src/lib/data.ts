    ...
    if (facilitiesSnapshot.empty) {
        ...
        const facilitiesToSeed: Omit<Facility, 'id'>[] = [
          ...
          },
          {
            ...
            images: ['https://images.unsplash.com/photo-1542751371-2cfb8c5417b3'],
          ...
          },
          {
            ...
            images: ['https://images.unsplash.com/photo-1555633514-99d6362572a1'],
          ...
          },
          {
            ...
            type: 'Studio',
            address: '212 Spoke Street, Cyberburg',
            city: 'Cyberburg',
            location: 'Tech Park',
            description: 'Indoor velodrome and cycling studio with virtual reality racing and professional coaching.',
            images: ['https://images.unsplash.com/photo-1594994405523-3719c8b725a5'],
            sports: [getSportById('sport-7')!],
            sportPrices: [{ sportId: 'sport-7', pricePerHour: 900 }],
            amenities: [getAmenityById('amenity-1')!, getAmenityById('amenity-3')!, getAmenityById('amenity-4')!, getAmenityById('amenity-2')!],
            operatingHours: [ { day: 'Mon', open: '06:00', close: '22:00' }, { day: 'Tue', open: '06:00', close: '22:00' }, { day: 'Wed', open: '06:00', close: '22:00' }, { day: 'Thu', open: '06:00', close: '22:00' }, { day: 'Fri', open: '06:00', close: '22:00' }, { day: 'Sat', open: '08:00', close: '20:00' }, { day: 'Sun', open: '08:00', close: '20:00' } ],
            rating: 4.9,
            isPopular: true,
            isIndoor: true,
            dataAiHint: 'indoor cycling velodrome',
          },
          {
            name: 'Rhythm Room Dance Studio',
            type: 'Studio',
            address: '5678 Beat Street, Starhaven',
            city: 'Starhaven',
            location: 'Arts District',
            description: 'A vibrant dance studio with sprung floors, full-length mirrors, and a high-quality sound system. All dance styles welcome.',
            images: ['https://images.unsplash.com/photo-1508700929628-666d8434de0f'],
            sports: [getSportById('sport-8')!],
            sportPrices: [{ sportId: 'sport-8', pricePerHour: 1100 }],
            amenities: [getAmenityById('amenity-2')!, getAmenityById('amenity-3')!, getAmenityById('amenity-4')!],
            operatingHours: [ { day: 'Mon', open: '09:00', close: '22:00' }, { day: 'Tue', open: '09:00', close: '22:00' }, { day: 'Wed', open: '09:00', close: '22:00' }, { day: 'Thu', open: '09:00', close: '22:00' }, { day: 'Fri', open: '09:00', close: '23:00' }, { day: 'Sat', open: '10:00', close: '23:00' }, { day: 'Sun', open: '10:00', close: '20:00' } ],
            rating: 4.8,
            isIndoor: true,
            dataAiHint: 'dance studio mirrors',
          },
          {
            name: 'The Majestic Theatre',
            type: 'Studio',
            address: '1 Stage Door, Starhaven',
            city: 'Starhaven',
            location: 'Theatreland',
            description: 'A historic theatre with a grand stage, available for rehearsals, productions, and corporate events.',
            images: ['https://images.unsplash.com/photo-1596956470007-2bf6095e7246'],
            sports: [getSportById('sport-10')!],
            sportPrices: [{ sportId: 'sport-10', pricePerHour: 5000 }],
            amenities: [getAmenityById('amenity-1')!, getAmenityById('amenity-2')!, getAmenityById('amenity-7')!],
            operatingHours: [ { day: 'Mon', open: '10:00', close: '23:00' }, { day: 'Tue', open: '10:00', close: '23:00' }, { day: 'Wed', open: '10:00', close: '23:00' }, { day: 'Thu', open: '10:00', close: '23:00' }, { day: 'Fri', open: '10:00', close: '23:00' }, { day: 'Sat', open: '10:00', close: '23:00' }, { day: 'Sun', open: '12:00', close: '18:00' } ],
            rating: 4.9,
            capacity: 500,
            isIndoor: true,
            dataAiHint: 'grand theatre stage',
          },
          {
            name: 'The Net Return',
            type: 'Court',
            address: '451 Ace Avenue, Cyberburg',
            city: 'Cyberburg',
            location: 'West Cyberburg',
            description: 'Indoor badminton courts designed for competitive play. Features excellent lighting and non-slip surfaces.',
            images: ['https://images.unsplash.com/photo-1558927123-140a399434e3'],
            sports: [getSportById('sport-4')!],
            sportPrices: [{ sportId: 'sport-4', pricePerHour: 750 }],
            amenities: [getAmenityById('amenity-1')!, getAmenityById('amenity-4')!],
            operatingHours: [ { day: 'Mon', open: '08:00', close: '23:00' }, { day: 'Tue', open: '08:00', close: '23:00' }, { day: 'Wed', open: '08:00', close: '23:00' }, { day: 'Thu', open: '08:00', close: '23:00' }, { day: 'Fri', open: '08:00', close: '23:00' }, { day: 'Sat', open: '08:00', close: '23:00' }, { day: 'Sun', open: '08:00', close: '23:00' } ],
            rating: 4.6,
            isIndoor: true,
            dataAiHint: 'badminton arena',
          },
          {
            name: 'Hilltop Soccer Pitch',
            type: 'Field',
            address: '77 Skyview Road, Starhaven',
            city: 'Starhaven',
            location: 'The Hills',
            description: 'A beautiful outdoor soccer field with stunning views of the city. Perfect for evening games under the stars.',
            images: ['https://images.unsplash.com/photo-1552064255-08e6f1f4e1f7'],
            sports: [getSportById('sport-1')!],
            sportPrices: [{ sportId: 'sport-1', pricePerHour: 950 }],
            amenities: [getAmenityById('amenity-1')!],
            operatingHours: [ { day: 'Mon', open: '07:00', close: '22:00' }, { day: 'Tue', open: '07:00', close: '22:00' }, { day: 'Wed', open: '07:00', close: '22:00' }, { day: 'Thu', open: '07:00', close: '22:00' }, { day: 'Fri', open: '07:00', close: '22:00' }, { day: 'Sat', open: '07:00', close: '22:00' }, { day: 'Sun', open: '07:00', close: '22:00' } ],
            rating: 4.7,
            isIndoor: false,
            dataAiHint: 'soccer field sunset',
          },
        ];
