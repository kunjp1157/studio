...
export function getStaticFacilities(): Facility[] {
    ...
    return [
      ...
      },
      {
        ...
        sportPrices: [
            { sportId: 'sport-3', price: 2000, pricingModel: 'per_hour_flat' },
      ...
      },
      {
        ...
        sportPrices: [
            { sportId: 'sport-7', price: 300, pricingModel: 'per_hour_per_person' },
            { sportId: 'sport-6', price: 800, pricingModel: 'per_hour_per_person' },
        ],
