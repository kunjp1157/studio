...
const mockRentalEquipment: RentalEquipment[] = [
    { id: 'equip-1', name: 'Soccer Ball', pricePerItem: 100, priceType: 'per_booking', stock: 50, sportIds: ['sport-1'] },
    { id: 'equip-2', name: 'Basketball', pricePerItem: 120, priceType: 'per_booking', stock: 40, sportIds: ['sport-2'] },
    { id: 'equip-3', name: 'Tennis Racket', pricePerItem: 200, priceType: 'per_hour', stock: 30, sportIds: ['sport-3'] },
    { id: 'equip-4', name: 'Tennis Balls (3-pack)', pricePerItem: 150, priceType: 'per_booking', stock: 60, sportIds: ['sport-3'] },
    { id: 'equip-5', name: 'Badminton Racket', pricePerItem: 150, priceType: 'per_hour', stock: 50, sportIds: ['sport-4'] },
    { id: 'equip-6', name: 'Shuttlecock (box)', pricePerItem: 100, priceType: 'per_booking', stock: 80, sportIds: ['sport-4'] },
    { id: 'equip-7', name: 'Cricket Bat', pricePerItem: 250, priceType: 'per_hour', stock: 20, sportIds: ['sport-6'] },
    { id: 'equip-8', name: 'Leather Ball', pricePerItem: 300, priceType: 'per_booking', stock: 30, sportIds: ['sport-6'] },
    { id: 'equip-9', name: 'Yoga Mat', pricePerItem: 50, priceType: 'per_booking', stock: 100, sportIds: ['sport-8'] },
    { id: 'equip-10', name: 'Volleyball', pricePerItem: 100, priceType: 'per_booking', stock: 40, sportIds: ['sport-9'] },
    { id: 'equip-11', name: 'Table Tennis Racket', pricePerItem: 80, priceType: 'per_hour', stock: 40, sportIds: ['sport-10'] },
    { id: 'equip-12', name: 'Boxing Gloves (pair)', pricePerItem: 150, priceType: 'per_hour', stock: 25, sportIds: ['sport-12'] },
    { id: 'equip-13', name: 'Hockey Stick', pricePerItem: 180, priceType: 'per_hour', stock: 30, sportIds: ['sport-18'] },
    { id: 'equip-14', name: 'Squash Racket', pricePerItem: 180, priceType: 'per_hour', stock: 20, sportIds: ['sport-11'] },
    { id: 'equip-15', name: 'Archery Bow & Arrows', pricePerItem: 300, priceType: 'per_hour', stock: 15, sportIds: ['sport-14'] },
];

const getEquipmentForFacility = (facilitySports: Sport[]): RentalEquipment[] => {
    const facilitySportIds = new Set(facilitySports.map(s => s.id));
    return mockRentalEquipment.filter(equip => equip.sportIds.some(sportId => facilitySportIds.has(sportId)));
};
...
export const getStaticFacilities = (): Facility[] => {
    ...
    const facilities: Omit<Facility, 'availableEquipment'>[] = [
      // Master Venues
      {
    ...
    return facilities.map(facility => ({
        ...facility,
        availableEquipment: getEquipmentForFacility(facility.sports),
    }));
};
