...
export const getStaticFacilities = (): Facility[] => {
    ...
    },
    {
      ...
      description: 'Modern indoor basketball and volleyball courts located centrally in Delhi.',
      sports: [sports[1], sports[8]],
      sportPrices: [
          { sportId: 'sport-2', price: 1800, pricingModel: 'per_hour_flat' },
          { sportId: 'sport-9', price: 1400, pricingModel: 'per_hour_flat' },
      ],
      amenities: [amenities[0], amenities[1], amenities[2], amenities[3], amenities[4]],
      operatingHours: [ { day: 'Mon', open: '07:00', close: '23:00' }, { day: 'Tue', open: '07:00', close: '23:00' }, { day: 'Wed', open: '07:00', close: '23:00' }, { day: 'Thu', open: '07:00', close: '23:00' }, { day: 'Fri', open: '07:00', close: '23:00' }, { day: 'Sat', open: '08:00', close: '23:00' }, { day: 'Sun', open: '08:00', close: '22:00' }, ],
      rating: 4.7,
      reviews: [],
      capacity: 80,
      isPopular: true,
      isIndoor: true,
      dataAiHint: 'basketball court Delhi',
      availableEquipment: [],
      ownerId: 'user-2'
  },
  {
      id: 'facility-7',
      name: 'Howrah Hockey Hub',
      type: 'Field',
      address: 'Maidan, Kolkata, West Bengal 700071',
      city: 'Kolkata',
      location: 'Maidan',
      description: 'A classic hockey field in the iconic Maidan area, perfect for competitive matches.',
      sports: [sports[17]],
      sportPrices: [
          { sportId: 'sport-18', price: 900, pricingModel: 'per_hour_flat' },
      ],
      amenities: [amenities[0], amenities[2]],
      operatingHours: [ { day: 'Mon', open: '06:00', close: '20:00' }, { day: 'Tue', open: '06:00', close: '20:00' }, { day: 'Wed', open: '06:00', close: '20:00' }, { day: 'Thu', open: '06:00', close: '20:00' }, { day: 'Fri', open: '06:00', close: '20:00' }, { day: 'Sat', open: '06:00', close: '20:00' }, { day: 'Sun', open: '06:00', close: '20:00' }, ],
      rating: 4.2,
      reviews: [],
      capacity: 120,
      isPopular: false,
      isIndoor: false,
      dataAiHint: 'hockey field Kolkata',
      availableEquipment: [],
      ownerId: 'user-2'
  },
  {
      id: 'facility-8',
      name: 'HITEC City Sports Park',
      type: 'Complex',
      address: 'Kondapur, Hyderabad, Telangana 500084',
      city: 'Hyderabad',
      location: 'HITEC City',
      description: 'A massive sports park catering to the tech crowd, with facilities for cricket, table tennis, and squash.',
      sports: [sports[5], sports[9], sports[10]],
      sportPrices: [
          { sportId: 'sport-6', price: 2000, pricingModel: 'per_hour_flat' },
          { sportId: 'sport-10', price: 500, pricingModel: 'per_hour_flat' },
          { sportId: 'sport-11', price: 600, pricingModel: 'per_hour_flat' },
      ],
      amenities: [amenities[0], amenities[1], amenities[2], amenities[3], amenities[4], amenities[5], amenities[6]],
      operatingHours: [ { day: 'Mon', open: '06:00', close: '23:00' }, { day: 'Tue', open: '06:00', close: '23:00' }, { day: 'Wed', open: '06:00', close: '23:00' }, { day: 'Thu', open: '06:00', close: '23:00' }, { day: 'Fri', open: '06:00', close: '23:00' }, { day: 'Sat', open: '06:00', close: '23:00' }, { day: 'Sun', open: '06:00', close: '23:00' }, ],
      rating: 4.8,
      reviews: [],
      capacity: 300,
      isPopular: true,
      isIndoor: true,
      dataAiHint: 'cricket nets Hyderabad',
      availableEquipment: [],
      ownerId: 'user-2'
  },
  {
      id: 'facility-9',
      name: 'Sabarmati Riverfront Arena',
      type: 'Box Cricket',
      address: 'Sabarmati Riverfront, Ashram Road, Ahmedabad, Gujarat 380009',
      city: 'Ahmedabad',
      location: 'Sabarmati Riverfront',
      description: 'Enjoy a game of box cricket with a scenic view of the Sabarmati Riverfront.',
      sports: [sports[5]],
      sportPrices: [
          { sportId: 'sport-6', price: 1300, pricingModel: 'per_hour_flat' },
      ],
      amenities: [amenities[0]],
      operatingHours: [ { day: 'Mon', open: '16:00', close: '23:00' }, { day: 'Tue', open: '16:00', close: '23:00' }, { day: 'Wed', open: '16:00', close: '23:00' }, { day: 'Thu', open: '16:00', close: '23:00' }, { day: 'Fri', open: '16:00', close: '23:00' }, { day: 'Sat', open: '15:00', close: '23:00' }, { day: 'Sun', open: '15:00', close: '23:00' }, ],
      rating: 4.4,
      reviews: [],
      capacity: 20,
      isPopular: false,
      isIndoor: false,
      dataAiHint: 'box cricket Ahmedabad',
      availableEquipment: [],
      ownerId: 'user-2'
  },
  {
      id: 'facility-10',
      name: 'Koregaon Park Fight Club',
      type: 'Studio',
      address: 'Lane No. 7, Koregaon Park, Pune, Maharashtra 411001',
      city: 'Pune',
      location: 'Koregaon Park',
      description: 'High-intensity training center specializing in boxing and martial arts.',
      sports: [sports[11], sports[15]],
      sportPrices: [
          { sportId: 'sport-12', price: 500, pricingModel: 'per_hour_per_person' },
          { sportId: 'sport-16', price: 450, pricingModel: 'per_hour_per_person' },
      ],
      amenities: [amenities[2], amenities[3], amenities[4]],
      operatingHours: [ { day: 'Mon', open: '06:00', close: '21:00' }, { day: 'Tue', open: '06:00', close: '21:00' }, { day: 'Wed', open: '06:00', close: '21:00' }, { day: 'Thu', open: '06:00', close: '21:00' }, { day: 'Fri', 'open': '06:00', 'close': '21:00' }, { day: 'Sat', 'open': '08:00', 'close': '18:00' }, { day: 'Sun', 'open': '08:00', 'close': '14:00' }, ],
      rating: 4.9,
      reviews: [],
      capacity: 30,
      isPopular: true,
      isIndoor: true,
      dataAiHint: 'boxing gym Pune',
      availableEquipment: [],
      ownerId: 'user-2'
  }
  ];
