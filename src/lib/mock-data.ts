...
export function getStaticFacilities(): Facility[] {
    ...
    return [
      ...
      },
      {
        ...
        ownerId: 'user-owner-dana',
        availableEquipment: standardEquipment.filter(e => e.sportIds.includes('sport-13')),
        maintenanceSchedules: [],
      },
      {
        id: 'facility-4',
      ...
      },
      {
        ...
        availableEquipment: standardEquipment.filter(e => e.sportIds.includes('sport-1')),
        maintenanceSchedules: [],
      },
      {
        id: 'facility-13',
        ...
        sportPrices: [
            { sportId: 'sport-2', price: 2800, pricingModel: 'per_hour_flat' },
            { sportId: 'sport-4', price: 1500, pricingModel: 'per_hour_flat' },
        ],
        ...
        availableEquipment: standardEquipment.filter(e => e.sportIds.includes('sport-2') || e.sportIds.includes('sport-4')),
        maintenanceSchedules: [],
      },
      {
        id: 'facility-14',
      ...
      },
      {
        ...
        sports: [allSports.find(s => s.id === 'sport-4')!],
        sportPrices: [{ sportId: 'sport-4', price: 1300, pricingModel: 'per_hour_flat' }],
      ...
      },
      {
        ...
        availableEquipment: standardEquipment.filter(e => e.sportIds.includes('sport-6') || e.sportIds.includes('sport-7')),
        maintenanceSchedules: [],
      },
      {
        id: 'facility-19',
        name: 'Jaipur Royals Cricket Academy',
        type: 'Complex',
        address: '5 Tonk Road, Jaipur, 302018',
        city: 'Jaipur',
        location: 'Tonk Road',
        description: 'A top-tier cricket academy with modern nets, bowling machines, and expert coaching available.',
        sports: [allSports.find(s => s.id === 'sport-13')!],
        sportPrices: [{ sportId: 'sport-13', price: 2800, pricingModel: 'per_hour_flat' }],
        amenities: mockAmenities.slice(0, 5),
        operatingHours: defaultOperatingHours,
        rating: 4.8,
        isPopular: true,
        isIndoor: false,
        dataAiHint: 'cricket academy',
        ownerId: 'user-owner-dana',
        availableEquipment: standardEquipment.filter(e => e.sportIds.includes('sport-13')),
        maintenanceSchedules: [],
      },
      {
        id: 'facility-20',
        name: 'Chandigarh Lake Club Courts',
        type: 'Court',
        address: 'Sukhna Lake, Sector 1, Chandigarh, 160001',
        city: 'Chandigarh',
        location: 'Sukhna Lake',
        description: 'Beautifully maintained tennis and badminton courts by the serene Sukhna Lake.',
        sports: [allSports.find(s => s.id === 'sport-3')!, allSports.find(s => s.id === 'sport-4')!],
        sportPrices: [
            { sportId: 'sport-3', price: 1600, pricingModel: 'per_hour_flat' },
            { sportId: 'sport-4', price: 1000, pricingModel: 'per_hour_flat' }
        ],
        amenities: [mockAmenities.find(a => a.id === 'amenity-1')!, mockAmenities.find(a => a.id === 'amenity-3')!, mockAmenities.find(a => a.id === 'amenity-6')!],
        operatingHours: defaultOperatingHours,
        rating: 4.6,
        isPopular: false,
        isIndoor: false,
        dataAiHint: 'lake club sports',
        availableEquipment: standardEquipment.filter(e => e.sportIds.includes('sport-3') || e.sportIds.includes('sport-4')),
        maintenanceSchedules: [],
      }
    ];
}
